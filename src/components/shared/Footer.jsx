...
const Footer = () => {
  return (
    <footer className="w-full py-8 border-t-2 border-primary/50 bg-black">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          <h2 className="text-primary font-bold text-4xl mb-4">HALLHUNT</h2>
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          <h2 className="text-primary font-bold text-lg mb-4">Services</h2>
          <ul className="text-primary">
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          <h2 className="text-primary font-bold text-lg mb-4">Help & FAQs</h2>
          <ul className="text-primary">
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          <h2 className="text-primary font-bold text-lg mb-4">Business</h2>
          <ul className="text-primary">
        ...
        <h2 className="text-primary font-bold text-lg mb-4">Keep in touch with us</h2>
